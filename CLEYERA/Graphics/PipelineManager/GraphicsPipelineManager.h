...
struct SPSO
{
	...
	SPSOProperty PhongModel;
	SPSOProperty TestNormalModel;
...
private:
	...
	static SPSOProperty CreateTestNormalModel(ComPtr<ID3D12Device>device, Commands commands, SShaderMode shader);
