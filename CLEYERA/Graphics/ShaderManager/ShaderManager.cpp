...
void ShaderManager::TestNormalModel()
{
	SShaderMode shaders;
	shaders.vertexBlob =
		ShaderManager::CompilerShaderFanc(
			L"Resources/Shader/testNormal.VS.hlsl",
			L"vs_6_0");

	shaders.pixelBlob =
		ShaderManager::CompilerShaderFanc(
			L"Resources/Shader/testNormal.PS.hlsl",
			L"ps_6_0");

	ShaderManager::Getinstance()->shaders_.TestNormalModel = shaders;
}
